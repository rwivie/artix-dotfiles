...
COLOR_DISCONNECTED='#2e3440'       # Device Disconnected
COLOR_NEWDEVICE='#a3be8c'          # New Device
COLOR_BATTERY_90='#eceff4'         # Battery >= 90
COLOR_BATTERY_80='#e5e9f0'         # Battery >= 80
COLOR_BATTERY_70='#d8dee9'         # Battery >= 70
